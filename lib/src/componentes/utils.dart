...
Future<Horario> fetchHorario() async {
  final url = Uri.parse(
      'https://sheets.googleapis.com/v4/spreadsheets/1D5bPHlNkj7bAlzJVIcL1CR7zo7PnZEAudV7aGvHgMvI/values/Sin_Formato!A2:H?key=AIzaSyDRk_vUZHqUVzdmeKV0CHHCzA2eCtZaBOM');
...
class Horario {
  ...
  const Horario({required this.filas});

  factory Horario.fromJson(Map<String, dynamic> json) {
    return Horario(filas: json['values']);
  }
}
